...
To make things easy, there is an already prepared data set for download. Just run the following code (don't forget to adjust the corresponding paths!).
...
```{r chunk_chapter6_chunk14, echo=FALSE, out.width="150%", out.height="150%"}
