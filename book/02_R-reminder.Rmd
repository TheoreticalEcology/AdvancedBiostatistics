...
For Windows / Mac, R should work out of the box. For Debian based systems, may also need to run
...
A fundamental requirement to working with data is representing it in a computer. In R, if I type

```{r}
x <- 1
```

the variable x now contains some data, namely the value 1, and I can use x in as a placeholder for the data it contains in further calculations. If you have worked with R, you should know this already, and you should also know that the commands
...
Allow you to explore you the structure of variables and the data they contain. Ask yourself, or discuss with your partner(s) - what is the meaning of the three functions, and what is the structure / properties of the following data types in R:
...
Moreover, what is the data type of the iris data set, which is build-in in R under the name
