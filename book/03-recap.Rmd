...
```{r chunk_chapter3_chunk60, echo=FALSE, eval=TRUE}
fit = lm(Ozone ~ Wind + Temp, data = airquality)
summary(aov(fit))
```
...
```{r chunk_chapter3_chunk61, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter3_chunk62, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter3_chunk63, echo=FALSE, eval=TRUE}
