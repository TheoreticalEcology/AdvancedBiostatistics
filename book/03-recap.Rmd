...
We can visualise the result via
...
* We estimate the mean Ozone (our line) to be at 42.12 +/- 3.1 units.
...
The most common case will be a model with slope and intercept which is probably corresponds most with our visual assessment. This time, I show the full regression table, so that we can also discuss the other outputs.
