...
```{r chunk_chapter3_chunk21, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter3_chunk22, echo=FALSE, eval=FALSE}
par(mfrow = c(2, 2))
```

which produces a figure with 2 x 2 = 4 panels.

```{r chunk_chapter3_chunk23, echo=FALSE, eval=TRUE}
par(mfrow = c(2, 2))
plot(fit)
```
...
```{r chunk_chapter3_chunk24, echo=FALSE, eval=TRUE}
