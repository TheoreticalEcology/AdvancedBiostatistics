...
```{r chunk_chapter4_chunk2, echo=FALSE, eval=FALSE}
...
```{r chunk_chapter4_chunk2, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter4_chunk3, echo=FALSE, eval=FALSE}
...
```{r chunk_chapter4_chunk4, echo=FALSE, eval=TRUE}
library(mgcv)
...
```{r chunk_chapter4_chunk5, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter4_chunk6, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter4_chunk7, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter4_chunk8, echo=FALSE, eval=TRUE}
set.seed(125)
...
```{r chunk_chapter4_chunk9, echo=FALSE, eval=TRUE}
...
```{r chunk_chapter4_chunk10, echo=FALSE, eval=TRUE}
library(nlme)
...
```{r chunk_chapter4_chunk11, echo=FALSE, eval=TRUE}
anova(fit)
```
...
```{r chunk_chapter4_chunk12, echo=FALSE, eval=TRUE}
library(glmmTMB)
...
```{r chunk_chapter4_chunk12, echo=FALSE, eval=FALSE}
