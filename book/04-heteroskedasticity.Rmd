...
2. Use the `gls`{.R} function (package `nlme`{.R}) with the untransformed response to make the variance dependent on Solar.R. Hint: Read in `corClasses`.{R} and decide how to model this.
...
```{r chunk_chapter4_chunk29, echo=TRUE, eval=TRUE}
library(EcoData)
