...
How can we check the residuals of a GLM? First of all: Due to an unfortunate programming choice in R (Nerds: Check class(m2)), the standard residual plots still work  
