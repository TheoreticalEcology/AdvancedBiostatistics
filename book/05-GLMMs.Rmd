...
```{r chunk_chapter5_task_5, message=FALSE, warning=FALSE}
library(readxl)
...
```{r chunk_chapter5_task_6, message=FALSE, warning=FALSE}
...
```{r chunk_chapter5_task_7, message=FALSE, warning=FALSE}
